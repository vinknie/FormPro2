...
class AdminFormateurController extends Controller
{
    public function index(){
        ...
        ->select('utilisateurs.nom' ,'utilisateurs.id' , 'utilisateurs.prenom','utilisateurs.email','utilisateurs.role','utilisateurs.sexe','utilisateurs.telephone',DB::raw('group_concat(formation.date_debut , " / " , formation.date_fin) as dateForm'),'formation.nom as nomForm','formation.id_formation',)
        ->groupBy('formation.id_formation','utilisateurs.id','utilisateurs.nom' , 'utilisateurs.prenom','utilisateurs.email','utilisateurs.role','utilisateurs.sexe','utilisateurs.telephone' ,'nomForm')
