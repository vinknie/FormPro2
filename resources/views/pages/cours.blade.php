...
@section('content')
    ...
    <div class="row">
        <div class="col-2" id="listChapter"></div>
        <div class="col-1"></div>
        <div class="col-9" id="CardChapter">
            <h4>Veuillez Selectionner la formation Puis la Matiere que vous souhaitez pour avoir access aux chapitres de la
                Matiere</h4>
            {{-- <div class="card">
                <div class="card-body">
                                    ...
                                    for (let j = 0; j < IdFilesSplit.length; j++){
                                        if(ExtFilesSplit[j] == 'pdf'){
                                            html2 += '<div class="row">\
                                                            <div class="col-3"></div>\
                                                                <div class="col-4 bg-danger">\
                                                                    ...
                                                                    <span>Telecharger le PDF '+NameFilesSplit[j]+': </span><a href="/cours/downloadFile/'+FileFilesSplit[j]+'" class="card-link">PDF link</a>\
                                                                </div>\
                                                            <div class="col-1"></div>\
                                                            <div class="col-4 bg-warning"><span>Visualiser le PDF: </span><a href="/cours/view/'+IdFilesSplit[j]+'" target="_blank" class="card-link">Visualiser</a></div>\
                                                        </div>'
                                            ...
                                            html2 += '<div class="row">\
                                                            ...
                                                            <div class="col-1"></div>\
                                                            <div class="col-4 bg-warning"><span>Visualiser la video: </span><a href="/cours/view/'+IdFilesSplit[j] +'" target="_blank" class="card-link">Visualiser</a></div>\
                                                        </div>'
                                        }else{
                                            html2 += '<p>Pas De Files Trouvé</p>'
                                        }
